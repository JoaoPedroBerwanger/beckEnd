...
if ($modo === 'editar' && $id > 0) {
  $q = $conn->query("SELECT * FROM forma_pagamento WHERE id = $id");
  if ($q && $q->num_rows > 0) {
    $reg = $q->fetch_assoc();
  }
}
...
<body class="bg">
  <div class="wrap">
    ...
    <div class="header">
      <div><?= $modo === 'editar' ? 'Editar Forma de Pagamento' : 'Nova Forma de Pagamento' ?></div>
    ...
    <div class="form-card">
      <form method="POST" action="../funcoes.php">
        ...
        <a class="button" href="formaPagamento_consulta.php">Cancelar</a>
      </form>
    </div>
